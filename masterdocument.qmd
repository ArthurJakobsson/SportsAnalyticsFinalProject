...
DBD_ZIP_binary <- glm(drivePoints>0 ~ more_runs+as.factor(posteam_type), data=dbd_no_neg, family = binomial)
summary(DBD_ZIP_binary)


DBD_ZIP <- glm(drivePoints>0 ~ runPercent+as.factor(posteam_type), data=dbd_no_neg, family = binomial)
summary(DBD_ZIP)
```
