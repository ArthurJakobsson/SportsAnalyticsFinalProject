...
DBD_ZIP <- gam(drivePoints>0 ~ s(runPercent)+as.factor(posteam_type), data=dbd_no_neg)
plot(DBD_ZIP, col="cornflowerblue", xlab="Percent of Plays that were Runs in Drive", ylab = "Relative Success s(")
```
